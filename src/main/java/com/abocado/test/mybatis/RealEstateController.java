package com.abocado.test.mybatis;
...
import com.abocado.test.mybatis.realEstateService.RealEstateService;
...
public class RealEstateController {
	...
	// 월세를 전달 받고, 해당 월세보다 낮은 월세 매줄 json으로 response에 담는다.
	@RequestMapping("/2")
	@ResponseBody
	...
	public int createRealEstate() {
		int count = realEstateService.addRealEstate(3, "푸르지용 러버 303동 1104호", 89, "매매", 100000);
